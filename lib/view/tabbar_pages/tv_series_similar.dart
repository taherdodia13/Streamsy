...
class TVSeriesSimilarPage extends StatefulWidget {
  final TVSeriesViewmodel viewmodel;
  const TVSeriesSimilarPage({super.key, required this.viewmodel});

  @override
  State<TVSeriesSimilarPage> createState() => _TVSeriesSimilarPageState();
}

class _TVSeriesSimilarPageState extends State<TVSeriesSimilarPage> {
  @override
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    width: 180.w,
                    child: Text(
                      widget.viewmodel.tvSeriesSimilarData.results[index]
                              .name ??
                          widget.viewmodel.tvSeriesSimilarData.results[index]
                              .originalName ??
                          '',
