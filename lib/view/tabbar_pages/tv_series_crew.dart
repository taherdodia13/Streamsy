...
class TVSeriesCrewPage extends StatefulWidget {
  final TVSeriesViewmodel viewmodel;
  const TVSeriesCrewPage({super.key, required this.viewmodel});

  @override
  State<TVSeriesCrewPage> createState() => _TVSeriesCrewPageState();
}

class _TVSeriesCrewPageState extends State<TVSeriesCrewPage> {
  @override
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: GridView.builder(
          ...
          itemCount: widget.viewmodel.tvSeriesAggregateCreditsData.crew.length,
                ...
                children: [
                  ClipRRect(
                    ...
                    child: FadeInImage(
                      ...
                      image: NetworkImage(
                          '${ServiceConfigurations.imagePath}/p/w185/${widget.viewmodel.tvSeriesAggregateCreditsData.crew[index].profilePath ?? ''}'),
                  ...
                  SizedBox(
                    width: 180.w,
                    child: Text(
                      widget.viewmodel.tvSeriesAggregateCreditsData.crew[index]
                              .name ??
                          widget.viewmodel.tvSeriesAggregateCreditsData
                              .crew[index].originalName ??
                          '',
